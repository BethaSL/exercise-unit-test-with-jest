...
test("One dollar should be 127.9 yens", function(){
    ...
    // if 1 dollar is 127.9 yens, then 3.5 dollars should be (3.5 * 127.9)
    const expected = 3.5 * 127.9; 
    
    // this is the comparison for the unit test
     expect(fromDollartoYen(3.5)).toBe(447.65000000000003); //1 dollar is 127.9 yens, then 3.5 dollars should be = (3.5 * 127.9)
})
